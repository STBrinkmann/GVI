...
IDW_cpp <- function(rast, x, sf_x, sf_y, sf_z, n, b, radius, mode = 1L, ncores = 1L, display_progress = FALSE) {
    .Call(`_GVI_IDW_cpp`, rast, x, sf_x, sf_y, sf_z, n, b, radius, mode, ncores, display_progress)
}
