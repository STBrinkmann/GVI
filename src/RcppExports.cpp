...
// VGVI_cpp2
Rcpp::NumericVector VGVI_cpp2(Rcpp::S4& dsm, const Rcpp::NumericVector& dsm_values, Rcpp::S4& greenspace, const Rcpp::NumericVector& greenspace_values, const Rcpp::IntegerVector x0, const Rcpp::IntegerVector y0, const int radius, const Rcpp::NumericVector& h0, const int fun, const double m, const double b, const int ncores);
RcppExport SEXP _GVI_VGVI_cpp2(SEXP dsmSEXP, SEXP dsm_valuesSEXP, SEXP greenspaceSEXP, SEXP greenspace_valuesSEXP, SEXP x0SEXP, SEXP y0SEXP, SEXP radiusSEXP, SEXP h0SEXP, SEXP funSEXP, SEXP mSEXP, SEXP bSEXP, SEXP ncoresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::S4& >::type dsm(dsmSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(VGVI_cpp2(dsm, dsm_values, greenspace, greenspace_values, x0, y0, radius, h0, fun, m, b, ncores));
    return rcpp_result_gen;
END_RCPP
}
// viewshed_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_GVI_VGVI_cpp2", (DL_FUNC) &_GVI_VGVI_cpp2, 12},
